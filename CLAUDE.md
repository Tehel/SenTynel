...
src/
  ...
  engine/                              # Three.js-backed render + game-loop layer
    ...
    bot.harness.test.ts Headless bot observatory, and the only practical way to debug the
                        ...
                        Landscapes 106, 600, 246, 16 and 35 are pinned as v2 wins at BOTH 15 and
                        16 ms; 35 additionally has a test of its own asserting ZERO aim misses and
                        a MEANIE among the things absorbed, since it is the fixture for the aiming
                        work (see engine/bot.ts's aimCandidates) rather than for a strategy.
