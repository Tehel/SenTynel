...
src/
  ...
  game/                                # Pure game rules — no `three` value imports at runtime
    ...
    botMovement.ts      How the bot moves, shared by every planner: the BotPlan intention,
                        ...
                        912 -> 924 on the verdict block (+14 -2), mean jump unchanged.
